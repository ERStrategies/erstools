---
title: "Dec. 2024 Template Script"
...
**ACTION: Replace "raw_data" with the same name of your data frame you used above, and run the code to inspect your data in either the Rmarkdown script (first line of code) or a separate view tab (second line of code)**
