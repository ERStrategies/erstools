...
**ACTION: Change the raw_data_folder_path to the path to your data. The folder path must start with a folder that is at the "Client Work" level. Exmaples include "District Partners", "Internal", "State Partners", etc.**
...
**ACTION: Change the processed_data_folder_path to the path to your data. The folder path must start with a folder that is at the "Client Work" level: "District Partners", "Internal", "State Partners", etc..**
