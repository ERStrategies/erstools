...
#' @param file_name_with_extension REQUIRED: Supported extensions: .csv, .xls, .xlsx. Example: "student_performance.csv"
...
#' @param clean_names OPTIONAL: standardizes column names by removing special characters, converting to snake_case, and ensuring uniqueness
